      ...
      <div className="h-full w-full">
        ...
        <nav className="fixed font-molle text-3xl hidden lg:flex py-4 shadow-none lg:shadow-md px-6 w-full flex justify-between items-center bg-white backdrop-filter backdrop-blur-lg bg-opacity-50 top-0 z-40">
          <div className="flex">
            ...
            <a
              href="/tokenmachines"
              className="font-mono ml-6 mr-2 mt-1 flex text-gray-700 text-center items-center text-sm leading-snug transition duration-500 ease-in-out transform hover:-translate-y-0.5"
            >
              token machines
            </a>
            <a
              ...
              <div className="px-6 h-full">
                <div className="flex flex-col justify-between h-full w-full">
                  <div>
                    ...
                    <ul className="f-m-m">
                      <a href="/tokenmachines" className="cursor-pointer">
